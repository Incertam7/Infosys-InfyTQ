...
class Performance:
    ...
    def change_position(self, child):
        double_step_pointer = self.__children_list.get_head()
        single_step_pointer = self.__children_list.get_head()

        while double_step_pointer.get_next() is not None:
            single_step_pointer = single_step_pointer.get_next()
            if double_step_pointer.get_next().get_next() is not None:
                double_step_pointer = double_step_pointer.get_next().get_next()
                
        self.__children_list.delete(child)
        self.__children_list.insert(child, single_step_pointer.get_data())
